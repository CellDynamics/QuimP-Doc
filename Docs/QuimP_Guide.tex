...
\begin{itemize}
	...
	\item Copy results to IJ table? - Open ImageJ table filled with fluorescence statistics computed for selected channel (the same are written to\textit{ stQP.csv} file).
\end{itemize}
