...
\noindent\fcolorbox{red}{yellow}{
	\parbox{\textwidth} {
		If objects (cells) in reconstructed image are darker than background, the image should be inversed before processing it in BOA module. Use \texttt{Edit$\rightarrow$Invert} to do that. Refer to section \ref{sec:BOAPlugin}.
	}
}
