...
\begin{enumerate}
	...
	\begin{itemize}
		\item Freeze cells - see \ref{sec:BOAPlugin}, \ref{sec:boaWorkflow}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item \textit{Freeze} - exclude cell from further modifications. Changes of segmentation parameters, plugins or segmentation of the whole sequence will not affect frozen cells.
	\end{itemize}
